...
const Formulario = () => {
    ...
    return (
        <>
            ...
            <form action="" className="bg-white py-10 px-5 shadow-md mb-10 lg:mb-5 rounded-md" onSubmit={handleSubmit}>
                <div className='mb-5'>
                ...
                <input type="submit" value={id ? 'Guardar Cambios' : 'Agregar Paciente'} className="bg-indigo-600 text-white rounded-lg w-full p-3 uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-colors"/>
