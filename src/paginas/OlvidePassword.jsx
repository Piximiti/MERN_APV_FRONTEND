          ...
          <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 roundex-sl bg-white'>
            ...
            <form action="" onSubmit={handleSubmit}>
                <div className="my-5">
                    ...
                    <input 
                      type="email" 
                      className="border w-full p-3 rounded-xl mt-3 bg-gray-50" 
                      placeholder="Email de Registro"
                      value={email} onChange={e => setEmail(e.target.value)} 
                    />
                </div>

                <input type="submit" value="Enviar Instrucciones" className="bg-indigo-700 text-white w-full py-3 px-10 rounded-xl uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto"/>
            </form>
