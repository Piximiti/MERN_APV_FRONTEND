                ...
                <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                    ...
                    <form action="" onSubmit={handleSubmit}>
                        <div className="my-3">
                            ...
                            <input type="text" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="nombre" value={perfil.nombre || ''} onChange={e => {
                                setPerfil({
                                    ...perfil,
                        ...
                        <div className="my-3">
                            ...
                            <input type="text" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="web" value={perfil.web || ''} onChange={e => {
                                setPerfil({
                                    ...perfil,
                                    [e.target.name]: e.target.value
                                })
                        ...
                        <div className="my-3">
                            ...
                            <input type="text" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="telefono" value={perfil.telefono || ''} onChange={e => {
                                setPerfil({
                                    ...perfil,
                                    [e.target.name]: e.target.value
                                })
                        ...
                        <div className="my-3">
                            ...
                            <input type="email" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="email" value={perfil.email || ''} onChange={e => {
                                setPerfil({
                                    ...perfil,
                                    [e.target.name]: e.target.value
                                })
